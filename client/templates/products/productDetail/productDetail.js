...
Template.productDetailBeesknees.onCreated(function () {
 ...
 * product data source
 */
Template.productDetailBeesknees.helpers({
  tagListProps() {
...
Template.productDetailBeesknees.events({
...
Template.productDetailFormBeesknees.onCreated(function () {
  this.state = new ReactiveDict();
...
Template.productDetailFormBeesknees.helpers({
  product() {
...
Template.productDetailFormBeesknees.events({
...
Template.productDetailSocialFormBeesknees.helpers({
  product() {
    return Template.instance().state.get("product");
  }
});

Template.productDetailSocialFormBeesknees.events({
 ...
 */
Template.productDetailDashboardControlsBeesknees.helpers({
  product() {
    return Template.instance().state.get("product");
  }
});
 ...
 */
Template.productDetailDashboardControlsBeesknees.events({
  "click [data-event-action=publishProduct]": function (event, template) {
    let errorMsg = "";
    const instance = Template.instance();
    const self = instance.state.get("product") || {};
