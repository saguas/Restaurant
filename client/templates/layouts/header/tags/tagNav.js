...
Template.tagNavBeesknees.onCreated(function () {
...
Template.tagNavBeesknees.onRendered(() => {
...
Template.tagNavBeesknees.onDestroyed(function () {
  // $(window).off("resize", this.onWindowResize);
});


Template.tagNavBeesknees.helpers({
...
Template.tagNavBeesknees.events({
